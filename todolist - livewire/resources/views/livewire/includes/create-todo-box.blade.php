            ...
            <div>
                <form>
                    <div class="mb-6">
                        ...
                        <input wire:model="name" name="name" type="text" id="title" placeholder="Tarefa"
                    ...
                    <button wire:click.prevent="create" type="submit"
                        class="px-4 py-2 bg-blue-500 text-white font-semibold rounded hover:bg-blue-600">Criar</button>
