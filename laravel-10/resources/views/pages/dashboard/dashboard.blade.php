...
@section('content')
    ...
    <div class="row mt-4">
        <div class="col-sm-6 mb-3 mb-sm-0">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">Total de produtos cadastrados no sistema.t.</p>
        ...
        <div class="col-sm-6">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Total de vendas cadastradas</h5>
                    <p class="card-text">Total de usuarios cadastrados no sistema.</p>
                    <a href="#" class="btn btn-primary">{{ $totalDeVendasCadastrada }}</a>
                </div>
            </div>
        </div>
    </div>
