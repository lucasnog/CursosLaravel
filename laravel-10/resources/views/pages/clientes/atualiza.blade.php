    ...
    <form class="form" method="POST" action="{{ route('atualizar.cliente', $findCliente->id) }}">
        ...
        <form>
            <div class="mb-3">
                ...
                <input value="{{ isset($findCliente->nome) ? $findCliente->nome : @old('nome') }}" type="text"
            ...
            <div class="mb-3">
                ...
                <input value="{{ isset($findCliente->email) ? $findCliente->email : @old('email') }}" type="text"
            ...
            <div class="mb-3">
                ...
                <input id="cep" value="{{ isset($findCliente->cep) ? $findCliente->cep : @old('cep') }}"
                    type="text" class="form-control @error('cep') is-invalid @enderror" name="cep">
            ...
            <div class="mb-3">
                ...
                <input id="endereco"
                    value="{{ isset($findCliente->endereco) ? $findCliente->endereco : @old('endereco') }}" type="text"
            ...
            <div class="mb-3">
                ...
                <input id="logradouro"
                    ...
                    type="text" class="form-control @error('logradouro') is-invalid @enderror" name="logradouro">
            ...
            <div class="mb-3">
                ...
                <input id="bairro" value="{{ isset($findCliente->bairro) ? $findCliente->bairro : @old('bairro') }}"
                    type="text" class="form-control @error('bairro') is-invalid @enderror" name="bairro">
